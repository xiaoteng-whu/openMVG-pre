...
int main(int argc, char **argv)
{
  ...
  /*std::string folder = "E:/xiao.teng/sfmIPI/3gpsfm/dataset/dji188/sfm.json";
  sSfM_Data_Filename = folder + "/sfm_data.json";
  sMatchesDir = folder;
  sOutDir = folder + "/gesfm";
  std::string gesfmfile = folder + "/dji188-c1.txt";*/
  std::string gesfmfile;
  cmd.add(make_option('g', gesfmfile, "gesfmfile"));
  ...
  if (sfmEngine.Process_gesfm(gesfmfile))
  {
