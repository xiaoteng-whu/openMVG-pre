...
int main(int argc, char **argv)
{
  ...
  (
    !(matches_provider->load(sfm_data, sMatchFilename))// use the specifical matchfile
  )
  {
    std::cerr << std::endl
  ...
  // handle the sfm_global_engine_relative_motions directly.
  //---------------------------------------
  ...
  if (sfmEngine.ProcessIO(sOutDir))
  {
