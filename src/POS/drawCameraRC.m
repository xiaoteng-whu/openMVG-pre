function drawCameraRC(Rc, w, h, f, scale, lineWidth)
...
%
plot3(V(1,[1 5]),V(2,[1 5]),V(3,[1 5]),'-b','LineWidth',lineWidth);
plot3(V(1,[1 6]),V(2,[1 6]),V(3,[1 6]),'-b','LineWidth',lineWidth);
plot3(V(1,[1 7]),V(2,[1 7]),V(3,[1 7]),'-b','LineWidth',lineWidth);
plot3(V(1,[1 8]),V(2,[1 8]),V(3,[1 8]),'-b','LineWidth',lineWidth);

plot3(V(1,[5 6 7 8 5]),V(2,[5 6 7 8 5]),V(3,[5 6 7 8 5]),'-b','LineWidth',lineWidth);
